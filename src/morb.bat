...
..\build_tools\nasm.exe -fobj inventory/hand.asm -o build/hand.o
..\build_tools\nasm.exe -fobj sun/sun.asm -o build/sun.o
..\build_tools\nasm.exe -fobj sun/sky.asm -o build/sky.o
...
..\build_tools\nasm.exe -fobj audio/sigmaudio_conversion.asm -o build/sigmaudio_conversion.o
..\build_tools\nasm.exe -fobj audio/sigmaudio.asm -o build/sigmaudio.o
...
..\build_tools\nasm.exe -fobj renderer/post_processing/post_processing.asm -o build/post_processing.o
