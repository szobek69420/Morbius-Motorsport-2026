...
hyperPlane_intersectWithLineSegment:
	...
	;calculate |distance1|*(point2-point1)/(|distance1+distance2|)
	push dword[ebp+12]
	push dword[ebp+16]
	lea eax, [ebp-16]
	push eax
	...
	divss xmm0, xmm1
	movss dword[esp+8], xmm0			;|distance1|/(|distance1|+|distance2|)
	mov eax, dword[esp]
	mov dword[esp+4], eax
	call vec4_scale
	
	;calculate the intersection point
	;point1 + |distance1|*(point2-point1)/((|distance1|+|distance2|))
	lea eax, [ebp-16]
	push eax
	push dword[ebp+12]
	push dword[ebp+20]
