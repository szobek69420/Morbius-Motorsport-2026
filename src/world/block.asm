...
section .rodata use32
	...
	BLOCKS:
	dd BLOCK_AIR, BLOCK_STONE, BLOCK_GRASS, BLOCK_DIRT, BLOCK_OAK_LOG, BLOCK_OAK_LEAVES
	
	BLOCK_TEXTURES:
	dd BLOCK_TEXTURE_AIR, BLOCK_TEXTURE_STONE, BLOCK_TEXTURE_GRASS, BLOCK_TEXTURE_DIRT, BLOCK_TEXTURE_OAK_LOG, BLOCK_TEXTURE_OAK_LEAVES
